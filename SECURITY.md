...
Out of scope: third-party public targets, private repositories, credentials, tokens, keys, live logs, production systems, network scanning, exploitation, persistence, evasion, malware, credential collection, and destructive actions.
